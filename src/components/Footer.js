    ...
    >
      ...
      <div className="flex flex-col  md:flex-row justify-between gap-24">
        ...
        <div className="w-full md:w-1/2 lg:w-1/4 flex flex-col gap-8">
          <p>24,Nehru Corner, Steel 24, gold , Vellore </p>
          <span className="font-semibold">porselvibalamurugan123@gmail.com</span>
          <span className="font-semibold">+91 9966591511</span>
          <div className="">
      ...
      {/* bottom   */}
      <div className="text-center mt-8">&copy; 2024 Porselvi</div>
    </div>
  );
};
